...
const BLOCK_NON_TERMINAL: Record<string, string> = {
  ...
  mj_class_extends_declaration: 'ClassDeclaration',
  ...
  mj_expr_and: 'Expression',
  mj_expr_less: 'Expression',
  mj_expr_plus: 'Expression',
  mj_expr_minus: 'Expression',
  mj_expr_times: 'Expression',
  ...
  mj_expr_true: 'Expression',
  mj_expr_false: 'Expression',
